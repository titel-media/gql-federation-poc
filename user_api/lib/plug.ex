defmodule UserApi.Graphql.Plug do
  @behaviour Plug
  import Plug.Conn
  require Logger
  ...
  defp query_request(conn, query) do
    ...
    case UserApi.Graphql.Query.run(query, op_name: operation, vars: variables) do
      ...
      {:error, data} ->
        Logger.debug("UserApi.Graphql.Plug error: #{inspect(data)}")
